...
* **API & Signature Validation:** Flags unsafe APIs (e.g., `gets`) and enforces argument count/type matching against function signatures.
...
* **Structural Labeling:** Nodes are labeled by construct (e.g., `if_statement`, `declaration`) to aid visualization.
